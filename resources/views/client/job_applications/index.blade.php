                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-1">
                                <a href="{{ route('client.job_applications.edit', $application->id) }}" class="btn btn-sm btn-secondary" style="color: white; text-shadow: 2px 2px 4px #000000;">Edit</a>
                                <form action="{{ route('client.job_applications.destroy', $application->id) }}" method="POST">
                                    @csrf @method('DELETE')
                                    <button onclick="return confirm('Delete this application?')" class="btn btn-sm btn-danger" style="color: white; text-shadow: 2px 2px 4px #000000;">Delete</button>
                                </form>
                            </div>
                        </td>
                    </tr>
