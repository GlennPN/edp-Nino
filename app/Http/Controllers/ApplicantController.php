    ...
    public function index(Request $request)
{
    ...
    $jobOpenings = JobOpening::all(); // Fetch job openings
    //$job_application = JobApplication::where('applicant_id', $applicantId->first()); // Assuming you want an existing job application
